  ...
  if(form){
    ...
    form.addEventListener('submit', function(e){
      ...
      savedData.enquiries.unshift({
        id:'enq-' + Date.now(),
        name:form.querySelector('[name="company"]').value.trim() || form.querySelector('[name="name"]').value.trim(),
        contact:form.querySelector('[name="name"]').value.trim() + ' / ' + form.querySelector('[name="email"]').value.trim(),
        phone:form.querySelector('[name="phone"]').value.trim(),
        service:form.querySelector('[name="service"]').value,
        location:'Website enquiry',
        details:form.querySelector('[name="message"]').value.trim(),
        received:'Just now',
        status:'New'
      });
